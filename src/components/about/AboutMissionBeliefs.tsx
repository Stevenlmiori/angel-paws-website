...
const beliefs: {
  ...
  {
    Icon: ShieldCheck,
    title: "Ministry Participants",
    body: "Angel Paws is a Christ-centered ministry. Team participants, leadership, and representation of the organization align with these biblical beliefs and our governing documents, including our bylaws and participant application.",
  },
];
