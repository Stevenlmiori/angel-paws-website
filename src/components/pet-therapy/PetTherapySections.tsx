  ...
  return (
    <>
      <section className="mx-auto max-w-screen-xl px-6 sm:px-10 lg:px-12">
        <div className="rounded-[2.5rem] bg-surface-container-low px-6 py-20 sm:px-10 md:rounded-[3rem] md:py-28 lg:px-12">
      ...
      <div className="section-tone-inverse w-full py-20 md:py-28">
        <div className="mx-auto max-w-screen-xl px-6 sm:px-10 lg:px-12">
          <div className="max-w-4xl md:mx-auto lg:mx-0">
            <h2 className="mb-6 font-serif text-3xl md:text-4xl">
              Clear Definitions
            </h2>
            <ul className="list-disc space-y-3 pl-6 text-lg leading-relaxed text-on-surface-inverse-muted">
              <li>
                <strong className="font-semibold text-on-surface-inverse">
                  Therapy dogs:
                </strong>{" "}
          ...
          <div className="mx-auto mt-16 max-w-4xl lg:mx-0 md:mt-24">
            <h2 className="mb-6 font-serif text-3xl md:text-4xl">
              What We See Every Day
            </h2>
            <ul className="list-disc space-y-4 pl-6 text-lg leading-relaxed text-on-surface-inverse-muted">
            ...
            <p className="mt-6 text-lg font-medium text-on-surface-inverse">
