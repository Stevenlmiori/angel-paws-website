export function HomeQuote() {
  return (
    <section className="section-tone-charcoal py-20 md:py-28">
      <div className="mx-auto max-w-4xl px-6 text-center sm:px-10 lg:px-12">
        <blockquote className="font-serif text-2xl leading-snug md:text-3xl md:leading-relaxed">
          ...
          <cite className="mt-5 block text-lg italic md:text-xl">
            Matthew 25:40
          </cite>
        </blockquote>
      </div>
