...
export const boardMembers: BoardMember[] = [
  {
    ...
    imageAlt: "Placeholder portrait for board member Sarah Jenkins",
  },
  {
    name: "Michael Chen",
    role: "Treasurer",
    ...
    imageAlt: "Placeholder portrait for board member Michael Chen",
  },
  {
    ...
    imageAlt: "Placeholder portrait for board member Elena Rodriguez",
  },
  {
    name: "David Thorne",
    role: "Strategy",
    ...
    imageAlt: "Placeholder portrait for board member David Thorne",
  },
  {
    name: "Maya Patel",
    role: "Community",
